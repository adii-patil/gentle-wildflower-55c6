...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/gentle-wildflower-55c6
```

A live public deployment of this template is available at [https://gentle-wildflower-55c6.templates.workers.dev](https://gentle-wildflower-55c6.templates.workers.dev)
